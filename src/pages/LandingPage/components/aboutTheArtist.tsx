    ...
    return(
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-gray-700 max-w-2xl mx-auto">
            With over 10 years of experience in the beauty industry, Sophia Carter is a professional makeup artist 
            dedicated to enhancing natural beauty and creating stunning looks for any occasion. Her passion for 
            makeup and commitment to client satisfaction make her a sought-after artist for weddings, special 
