...
const ServiceGrid: React.FC<ServiceGridProps> = ({ title, services }) => {
    ...
    return (
        <section className="mb-16">
            <h2 className="text-2xl font-bold mb-6 text-[#3F6C54]">{title}</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {visibleServices.map((service) => (
                    <div
                        ...
                        onClick={() =>
                            navigate(
                                `/services/${service.category}/${service.title}`
                            )
                        }
                    >
                        <img
                        ...
                        <div className="p-4">
                            ...
                            <p className="text-[#527B62] font-medium mb-1">
                                ${service.price}
                            </p>
            ...
            {services.length > 4 && (
                <div className="text-center mt-6">
                    <button
                        className="text-[#527B62] font-semibold hover:underline cursor-pointer"
        ...
        <div>
            <div className="min-h-screen bg-[#f8f4f2] pt-20 ">
                <div className="max-w-7xl mx-auto px-4 py-8">
                    <h1 className="text-4xl font-bold mb-8 text-center text-[#3F6C54] ">
                        Services
                    </h1>
