        ...
        <div>
            ...
            <div className="max-w-4xl mx-auto py-12 px-4 mt-10">
                <Helmet>
                    ...
                    <link
                        rel="canonical"
                        href={`https://yourdomain.com/services/${service.category}/${slug}`}
                    />
                ...
                <button
                    className="mt-6 bg-green-600 text-white px-6 py-2 rounded-full hover:bg-green-700 cursor-pointer"
