...
const ClientInquiryPage=()=>{
    ...
    name: '', email: '', phone: '', eventDate: '', eventType: '', details: ''
  });
...
<div className="min-h-screen bg-white pt-20">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <form className="space-y-6 mb-12">
          ...
          <div>
            <label className="block text-sm font-medium mb-2">Inquiry Details</label>
            <textarea
              rows={4}
              className="w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <div className="flex items-center justify-between mb-2">
                  <div>
                    <h3 className="font-semibold">Chloe Harper</h3>
                ...
                <p className="text-gray-700">
                  I had a fantastic experience with Glamify for my engagement photoshoot. The makeup artist was professional, 
                  talented, and made me feel beautiful. The makeup lasted all day and looked amazing in the photos. 
          ...
          <div className="bg-gray-50 rounded-lg p-6">
            <div className="border-b pb-4 mb-4">
              <div className="flex items-center space-x-2 mb-4">
                <span className="text-green-500 font-semibold">Glamify</span>
              </div>
              <div className="bg-white rounded-lg p-4 shadow-sm">
                <p className="text-gray-700">
                  Hi Olivia, thank you for your inquiry! I'm available on September 22nd and would love to discuss 
                  your wedding makeup. I'll send you a detailed package and quote shortly. Do you have any reference 
                  photos of the looks you're interested in?
                </p>
              </div>
            </div>
