                        ...
                        <div className="flex items-start space-x-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-700">
                                    I had a fantastic experience with Glamify
                                    for my engagement photoshoot. The makeup
                                    artist was professional, talented, and made
                                    me feel beautiful. The makeup lasted all day
                                    and looked amazing in the photos. I highly
                                    recommend their services!
                                </p>
                                <div className="flex items-center space-x-4 mt-4">
                                    <button className="flex items-center text-gray-500 hover:text-gray-700">
                                        <ThumbsUp className="w-5 h-5 mr-1" />3
                                    </button>
                                    <button className="flex items-center text-gray-500 hover:text-gray-700">
                    ...
                    <div className="bg-gray-50 rounded-lg p-6">
                        <div className="border-b pb-4 mb-4">
                            ...
                            <div className="bg-white rounded-lg p-4 shadow-sm">
                                <p className="text-gray-700">
                                    Hi Olivia, thank you for your inquiry! I'm
                                    available on September 22nd and would love
                                    to discuss your wedding makeup. I'll send
                                    you a detailed package and quote shortly. Do
                                    you have any reference photos of the looks
